...
const { createGoogleCalendarEvent, updateGoogleCalendarEvent, deleteGoogleCalendarEvent } = require('./googleCalendar');
const { sendAppointmentConfirmation, sendAppointmentUpdate, sendAppointmentCancellation } = require('./emailService');
